...
<?php var_dump($data_hdd); ?>	
	<?php foreach($data_hdd as $row) :?>
		...
		<tr>
		    <td style="padding:10px;"><label>Used Space :</label></td><td style="padding:10px;"><?php echo ((($row->used)/1000)/1000)/1000; echo " GB"; ?> (<?php echo $row->percent."%" ?>)</td>
		</tr>
		<tr>
		    <td style="padding:10px;"><label>Free Space :</label></td><td style="padding:10px;"><?php echo ((($row->free)/1000)/1000)/1000; echo " GB"; ?> (<?php echo 100-$row->percent."%" ?>)</td>
		</tr>
		<tr>
		    <td style="padding:10px;"><label>Total Space :</label></td><td style="padding:10px;"><?php echo ((($row->total)/1000)/1000)/1000; echo " GB"; ?></td>
		</tr>
	    </table>
